...
export const EARTH_ORBIT_SPEED = 1.0; // Base orbit speed
export const MOON_ORBIT_SPEED = 0.5; // Moon orbit speed around Earth
export const EARTH_ROTATION_SPEED = 0.1;
export const CLOUD_ROTATION_SPEED = 0.12;
export const SOLAR_SYSTEM_ORBIT_SPEED_FACTOR = 0.1; // General speed multiplier for all planet orbits (Restored original value)
